...
basic_charge = {10: Decimal("286.00"), 15: Decimal("429.00"), 20: Decimal("572.00"), 30: Decimal("858.00"), 40: Decimal("1144.00"), 50: Decimal("1430.00"), 60: Decimal("1716.00")}
...
def total_calc(capacity, usage):
    ...
    return math.ceil(basic_cost + power_charge_calc(usage) + fuel_cost_calc(usage) + renewable_energy_calc(usage))
